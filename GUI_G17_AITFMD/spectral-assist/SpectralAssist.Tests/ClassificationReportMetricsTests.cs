...
public class ClassificationReportMetricsTests
{
    [Fact]
    public void Fraction_ReturnsNull_WhenNoPredictions()
    {
        var r = new ClassificationReport { Predictions = [] };
        Assert.Null(ClassificationReportMetrics.FractionPatchesWithClassProbabilityOverThreshold(r));
    }

    [Fact]
    public void Fraction_ReturnsNull_WhenClassIndexMissing()
    {
        var r = new ClassificationReport
        {
            Predictions =
            [
        ...
        Assert.Null(ClassificationReportMetrics.FractionPatchesWithClassProbabilityOverThreshold(r, classIndex: 1));
    }
    ...
    public void Fraction_AllOverThreshold_ReturnsOne()
    {
        ...
        var f = ClassificationReportMetrics.FractionPatchesWithClassProbabilityOverThreshold(r);
        Assert.Equal(1.0, f);
    }
    ...
    public void Fraction_Mixed_CountsCorrectly()
    {
        ...
        Assert.True(ClassificationReportMetrics.TryCountPatchesWithClassProbabilityOverThreshold(
            r, out var over, out var total));
        Assert.Equal(2, over);
        Assert.Equal(3, total);
        Assert.Equal(2.0 / 3.0, ClassificationReportMetrics.FractionPatchesWithClassProbabilityOverThreshold(r));
    }
